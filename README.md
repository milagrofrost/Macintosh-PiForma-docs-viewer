...
- `src/main.ts` owns viewer state, rendering, navigation, and Update Stack feedback.
...
- Optional age-based automatic checks on application startup.
- Cache repository images referenced by the Markdown.
- User-editable refresh policy and diagnostics.
